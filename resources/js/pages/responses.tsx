        ...
        <div className="relative z-10 py-6">
          <div className="px-6">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <Card className="bg-card text-card-foreground flex flex-col rounded-xl shrink-0 ring-muted/60 border shadow-sm ring-3" data-slot="card">
              ...
              <Card className="ring-muted/60 border shadow-sm ring-3">
                <CardHeader className="@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 px-5 pt-4 has-[data-slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-2">
                  ...
                  <CardDescription>The number of responses generated by each model over the last 7 days.</CardDescription>
                </CardHeader>
